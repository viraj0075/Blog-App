  ...
  return (
    <div className="w-full text-gray-700 bg-[#030d2e] bg-opacity-50 dark:text-gray-200 dark:bg-[#030d2e] dark:bg-opacity-1">
      <div className="lg:mx-[15rem] flex flex-col px-4 md:items-center md:justify-between md:flex-row md:px-6 lg:px-12">
        ...
        >
          <Link  className="px-4 py-2 mt-2 text-sm font-semibold bg-transparent rounded-lg dark:bg-transparent dark:hover:bg-orange-100 dark:focus:bg-orange-100 dark:text-gray-200 md:mt-0 md:ml-4 hover:text-gray-900 focus:text-gray-900 hover:bg-gray-200 focus:bg-gray-200 focus:outline-none focus:shadow-outline"
          to={`/updateuser/${id}`}
          >
            {user}
          </Link>
